...
This repo is a copy of `dependabot-test-monorepo`, but with a `dependabot.yml` file added with groups. The goal is to get 1 group per workspace (ie. 1 group for package-a and another for package-b)
